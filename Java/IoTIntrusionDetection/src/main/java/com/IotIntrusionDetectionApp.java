...
public class IotIntrusionDetectionApp {

	private static Logger log = LoggerFactory.getLogger(IotIntrusionDetectionApp.class);

    public static void main(String[] args) {
        ApplicationContext ctx = SpringApplication.run(IotIntrusionDetectionApp.class, args);
