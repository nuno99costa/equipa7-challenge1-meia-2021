package org.engcia.iotIntrusionDetection;
...
public class IoTIntrusionDetection {
    ...
    private static void runEngine() {
        try {
            IoTIntrusionDetection.justifications = new TreeMap<Integer, Justification>();

            // load up the knowledge base
            KieServices ks = KieServices.Factory.get();
            KieContainer kContainer = ks.getKieClasspathContainer();
            final KieSession kSession = kContainer.newKieSession("ksession-rules");
            IoTIntrusionDetection.KS = kSession;
            IoTIntrusionDetection.agendaEventListener = new TrackingAgendaEventListener();
